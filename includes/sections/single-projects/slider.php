<div class="important mb-150">
    <div class="container">
        <div class="important__content">
            <div class="important__content_info text">
                <?php echo get_sub_field( 'important_info' ); ?>
                <?php $importantProjectLink = get_sub_field('important_url'); ?>
                <?php if ( $importantProjectLink ): ?>
                    <a href="<?php echo esc_url( $importantProjectLink['url']) ?>" class="btn btn-content" target="_blank">
                        <?php echo esc_html( $importantProjectLink['title']) ?>
            ...
            <div class="important__content_slider">
                <div class="important-slider">
                    <?php if ( have_rows( 'important_slider' ) ): ?>
                        <?php while ( have_rows( 'important_slider' ) ) : the_row(); ?>
                            <div class="important__content_slider--photo">
                                <img src="<?php echo get_sub_field('important_slider_photo') ?>"/>
                            </div>
                        <?php endwhile; ?>
                    <?php endif; ?>
                </div>
