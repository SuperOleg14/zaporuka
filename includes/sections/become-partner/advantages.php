<div class="advantages m-150">
    <div class="container">
        <h2 class="title"><?php echo get_sub_field( 'advantages_title'); ?></h2>
        <div class="advantages__content d-flex --just-space --align-stretch f-wrap">
            <div class="advantages__content_left">
                <div class="text">
                    <?php echo get_sub_field( 'advantages_text'); ?>
                </div>
                <a href="#" class="btn btn-content">
                    Благодійність на роботі
            ...
            <div class="advantages__content_right d-flex --just-space --align-stretch f-wrap">
                <?php if ( have_rows( 'advantages_content' ) ): ?>
                    <?php while ( have_rows( 'advantages_content' ) ) : the_row(); ?>
                        <div class="advantages__content_right--item --basis-2">
                            <?php echo get_sub_field( 'advantages_content_text'); ?>
                        </div>
                    <?php endwhile; ?>
                <?php endif; ?>
            </div>
