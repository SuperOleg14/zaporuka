<?php if( have_rows('our_partners' , 'options') ): ?>
    <?php while( have_rows('our_partners', 'options') ): the_row(); ?>
        <div class="our-partners m-150">
            <div class="container">
                ...
                <div class="our-partners__content d-flex --just-space --align-stretch f-wrap">
                    <?php if ( have_rows( 'our_partners_content' ) ): ?>
                        <?php while ( have_rows( 'our_partners_content' ) ) : the_row(); ?>
                            <div class="our-partners__content_item d-flex --jc-center --align-center">
                                <img src="<?php echo get_sub_field('our_partners_content_photo') ?>"/>
                            </div>
                        <?php endwhile; ?>
                    <?php endif; ?>
                </div>
                <a href="<?php echo home_url('/partners/'); ?>" class="btn btn-content --content-margin">
                    Всі партнери
