<?php if( have_rows('about_volunteering' , 'options') ): ?>
    <?php while( have_rows('about_volunteering', 'options') ): the_row(); ?>
        <div class="about-volunteering m-150">
            <div class="container">
                <h2 class="title">
                    <?php echo get_sub_field( 'about_volunteering_title'); ?>
                </h2>
                <div class="about-volunteering__content d-flex --just-space --align-stretch">
                    <div class="about-volunteering__content_photo --basis-2">
                        <img src="<?php echo get_sub_field('about_volunteering_photo') ?>"/>
                    </div>
                    <div class="about-volunteering__content_info --basis-2 d-flex --just-space --align-stretch f-wrap">
                        <?php if ( have_rows( 'about_volunteering_info') ): ?>
                            <?php while ( have_rows( 'about_volunteering_info') ) : the_row(); ?>
                                <div class="about-volunteering__content_item --basis-2">
                                    <div class="d-flex --align-center">
                                        <?php echo get_sub_field( 'about_volunteering_info_icon'); ?>
                                        <div class="about-volunteering__content_title">
                                            <?php echo get_sub_field( 'about_volunteering_info_title'); ?>
                                        </div>
                                    </div>
                                    <div class="about-volunteering__content_text">
                                        <?php echo get_sub_field( 'about_volunteering_info_text'); ?>
                                    </div>
                                </div>
                            <?php endwhile; ?>
                        <?php endif; ?>
                ...
                <a href="<?php echo home_url('/staty-volonterom/'); ?>" class="btn btn-transparent btn-content">
                    Більше про нас
