    ...
    <div class="container">
        ...
        <div class="current-fees__tab">
            <div class="current-fees__content f-wrap completed">
                <?php if( $implemented_projects = get_sub_field('implemented_projects') ) :
                    foreach( $implemented_projects as $post ): setup_postdata($post);
                        $project_id = get_the_ID();
                        $total_amount = (float) get_field('total-amount', $project_id);
                        $total_collected = (float) get_field('total-collected', $project_id);
            ...
            <div class="current-fees__content f-wrap active">
                <?php if( $active_projects = get_sub_field('active_projects') ) :
                    foreach( $active_projects as $post ): setup_postdata($post);
                        $project_id = get_the_ID();
